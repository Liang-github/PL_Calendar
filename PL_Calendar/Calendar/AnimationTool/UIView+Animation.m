...
- (void)rotateWithCenterPoint:(CGPoint)point angle:(float)angle duration:(float)secs {
    ...
    tranform = CATransform3DRotate(tranform, angle, 1, 1, 1);
...
- (void)rotate:(int)degrees secs:(float)secs delegate:(id)delegate callBack:(SEL)method {
    [UIView animateWithDuration:secs delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
...
- (void)spinClockwise:(float)secs {
    [UIView animateWithDuration:secs/4 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
...
- (void)pulse:(float)secs continuously:(BOOL)continuously {
    [UIView animateWithDuration:secs/2 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        self.alpha = 0.3;
    } completion:^(BOOL finished) {
        [UIView animateWithDuration:secs/2 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
            self.alpha = 1;
...
- (void)particleAnimationImage:(NSString *)image {
    ...
    cell.birthRate = 20;
    cell.lifetime = 2;
    cell.color = [UIColor colorWithDisplayP3Red:1 green:0.5 blue:0.1 alpha:1].CGColor;
    cell.alphaSpeed = -0.4;
